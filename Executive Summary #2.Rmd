...
```{r}
table60 <- matrix(c("Description of Fixed Acidity", "Description of Volatile Acidity", "Description of Citric Acid", "Description of Residual Sugar", "Description of Chlorides", "Description of Free Sulphur Dioxide","Description of Total Sulphur Dioxide", "Description of Density", "Description of pH", "Description of Sulphates",  "Description of Alcohol", "Description of Quality"), ncol=1, byrow=TRUE)
