...
```{r}
table60 <- matrix(c("The fixed acidity is a measure of the tartaric, malic, citric and succinic, found within grapes, which are measured by a steam distillation of a sample of the wine. 
", "The fixed acidity is a measure of the tartaric, malic, citric and succinic, found within grapes, which are measured by a steam distillation of a sample of the wine. 
", "Description of Citric Acid", "Description of Residual Sugar", "Description of Chlorides", "Description of Free Sulphur Dioxide","Description of Total Sulphur Dioxide", "Description of Density", "Description of pH", "Description of Sulphates",  "Description of Alcohol", "Description of Quality"), ncol=1, byrow=TRUE)
