...
In this project, we will explore the 'red-wine quality' dataset to research relavance between each facotrs. The attributes in the dataset are following: "fixed acidity","volatile acidity","citric acid","residual sugar","chlorides","free sulfur dioxide","total sulfur dioxide","density","pH","sulphates","alcohol","quality"
